...
//Questio-3 Print the length of the string on the browser console using console.log()
...
console.log(challenge.match(/s/gi))
console.log(challenge.match(/f/gi))
...
console.log(py.match(/on/gi))
console.log(ja.match(/on/gi))

// Question-6 I hope this course is not full of jargon. Check if jargon is in the sentence.

let findSen = 'I hope this course is not full of jargon.'

console.log(findSen.search('Jargon'))
...
console.log('JavaScript'.charAt(Math.random()*11))
...
// Question-3 Clean the following text and find the most frequent word (hint, use replace and regular expressions).
    ...
    // const missSentence = '%I $am@% a %tea@cher%, &and& I lo%#ve %te@a@ching%;. The@re $is no@th@ing; &as& mo@re rewarding as educa@ting &and& @emp%o@weri@ng peo@ple. ;I found tea@ching m%o@re interesting tha@n any ot#her %jo@bs. %Do@es thi%s mo@tiv#ate yo@u to be a tea@cher!? %Th#is 30#Days&OfJavaScript &is al@so $the $resu@lt of &love& of tea&ching'
     
    //  console.log(missSentence.match(/\W/g))
    //  console.log(missSentence.replace(/[^A-Za-z\s]*/g,''))
...
// Qusetion-3 Calculate the total annual income of the person by extracting the numbers from the following text. 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.'
